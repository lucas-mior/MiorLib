...
connector RealOutput3 = output Real "input connector without name" annotation(
  ...
  Icon(coordinateSystem(extent = {{-50, -50}, {50, 50}}, preserveAspectRatio = true, initialScale = 1.0, grid = {5, 5}), graphics = {Polygon(lineColor = {255, 255, 255}, fillColor = {255, 255, 255}, fillPattern = FillPattern.Solid,lineThickness = 2, points = {{-75, 50}, {50, 0}, {-75, -50}, {-75, 50}}), Line(origin = {-0.45, 0}, points = {{-49.5528, 40}, {50.4472, 0}, {-49.5528, -40}}, thickness = 4)}),
