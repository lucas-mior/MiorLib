...
connector RealOutput2 = output Real "input connector without name and invisible icon" annotation(
  ...
  Icon(coordinateSystem(extent = {{-50, -50}, {50, 50}}, preserveAspectRatio = true, initialScale = 1, grid = {5, 5}), graphics = {Rectangle(lineColor = {255, 255, 255}, lineThickness = 0.01, extent = {{-50, 50}, {50, -50}})}),
