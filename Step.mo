...
equation
  ...
  annotation(
    Icon(coordinateSystem(preserveAspectRatio = true, extent = {{-100, -100}, {100, 100}}, grid = {5, 5}, initialScale = 1), graphics = {Rectangle(lineColor = {0, 0, 250}, extent = {{-100, -100}, {100, 100}}), Text(origin = {25, -155}, textColor = {200, 0, 0}, extent = {{-100, 50}, {100, 80}}, textString = "t=%t", horizontalAlignment = TextAlignment.Left), Text(origin = {10, -75}, textColor = {190, 0, 0}, extent = {{-50, 0}, {150, 30}}, textString = "H0=%offset", horizontalAlignment = TextAlignment.Left), Text(origin = {25, 115}, textColor = {190, 0, 0}, extent = {{-120, -40}, {50, -10}}, textString = "dH=%height", horizontalAlignment = TextAlignment.Left), Line(origin = {-30.7524, -9.93735}, points = {{-70, -50}, {-10, -50}, {-10, 90}, {70, 90}}, thickness = 3), Line(origin = {-61.2524, 14.3918}, points = {{0.5, 60}, {0.5, -60}, {-9.5, -60}, {10.5, -60}, {0.5, -60}, {0.5, 60}, {10.5, 60}, {-9.5, 60}, {-9.5, 60}}, color = {0, 0, 160}), Text(origin = {0, 120}, textColor = {0, 0, 127}, extent = {{-100, 35}, {100, -35}}, textString = "%name")}),
