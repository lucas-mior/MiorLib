...
connector RealInput = input Real "'input Real' as connector" annotation(
  ...
  Icon(coordinateSystem(extent = {{-50, -50}, {50, 50}}, preserveAspectRatio = true, initialScale = 1, grid = {5, 5}), graphics = {Text(origin = {-10, 0},textColor = {0, 0, 120}, extent = {{-50, -30}, {0, 30}}, textString = "%name", horizontalAlignment = TextAlignment.Right), Polygon(origin = {50, 0}, fillPattern = FillPattern.Solid, lineThickness = 0.8, points = {{-50, 50}, {-50, -50}, {50, 0}, {-50, 50}})}),
