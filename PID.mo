...
block PID
  ...
  RealInput SP annotation(
    Placement(transformation(origin = {-300, 75}, extent = {{-25, -25}, {25, 25}}), iconTransformation(origin = {-300, 75}, extent = {{-25, -25}, {25, 25}})));
...
equation
  ...
  Icon(coordinateSystem(extent = {{-300, -200}, {300, 200}}, initialScale = 1, grid = {5, 5}), graphics = {Text( extent = {{-100, 50}, {100, -50}}, textString = "PID", fontName = "Lucida Console"), Rectangle( lineThickness = 3, extent = {{140, 120}, {-140, -120}}),         
  Text(
  ...
  version = "",
  Diagram(coordinateSystem(extent = {{-300, -200}, {300, 200}}, grid = {5, 5}, initialScale = 1)));
end PID;