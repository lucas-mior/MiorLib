...
a lot by removing one strong nonlinearity from the initialization problem.
  ...
  Icon(coordinateSystem(preserveAspectRatio = true, extent = {{-100, -100}, {100, 100}}, initialScale = 1, grid = {5, 5}), graphics = {Line(points = {{0, -90}, {0, 68}}, color = {192, 192, 192}), Polygon(lineColor = {192, 192, 192}, fillColor = {192, 192, 192}, fillPattern = FillPattern.Solid, points = {{0, 90}, {-8, 68}, {8, 68}, {0, 90}}), Line(points = {{-90, 0}, {68, 0}}, color = {192, 192, 192}), Polygon(lineColor = {192, 192, 192}, fillColor = {192, 192, 192}, fillPattern = FillPattern.Solid, points = {{90, 0}, {68, -8}, {68, 8}, {90, 0}}), Line(points = {{-80, -70}, {-50, -70}, {50, 70}, {80, 70}}, thickness = 2), Text(extent = {{-150, -150}, {150, -110}}, textString = "[%uMin, %uMax]"), Line(visible = strict, points = {{50, 70}, {80, 70}}, color = {255, 0, 0}), Line(visible = strict, points = {{-80, -70}, {-50, -70}}, color = {255, 0, 0}), Rectangle(lineColor = {0, 0, 127}, lineThickness = 2, extent = {{-100, 100}, {100, -100}})}),
